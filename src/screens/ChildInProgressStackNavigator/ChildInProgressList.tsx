...
import {
  ChildInProgressStackNavigatorNavigationProp,
  ChildInProgressStackNavigatorParamList,
} from '../../navigators/ChildInProgressStackNavigator';
import SharedStyles from '../../shared/SharedStyles';
import { formatSections, ProgressState } from '../../shared/Utils';

type ChildInProgressListScreenNavigationProp = CompositeNavigationProp<
  StackNavigationProp<
    ChildInProgressStackNavigatorParamList,
    'ChildInProgressList'
  >,
...
type ChildInProgressListScreenRouteProp = RouteProp<
  ChildInProgressStackNavigatorParamList,
  'ChildInProgressList'
>;

interface IProps {
  navigation: ChildInProgressListScreenNavigationProp;
  route: ChildInProgressListScreenRouteProp;
}

@observer
export class ChildInProgressList extends React.Component<IProps> {
